...
IncidencePlane = IncidencePlane / sqrt(IncidencePlane*IncidencePlane');
...
%theta0 = -theta0;
%Reflected = (TransMat*ReflectionNormal')
...
Result.BraggAngle = BraggAngle * 180/pi;
%Check = psi_i + psi_r + 2*Result.BraggAngle
